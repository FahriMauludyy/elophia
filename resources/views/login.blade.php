...
<body>
    <div class="login-page w-screen h-screen bg-main flex justify-center items-center">
        <div class="w-[80%] flex justify-center items-center">
            <div class="card w-[35%] h-[480px] bg-white flex flex-col text-center justify-center py-10">
                <h1 class="text-2xl">Elophia</h1>
                <h1 class="text-4xl my-8">Welcome Back!</h1>

                <div class="input-area flex justify-center space-y-5 items-center flex-col">
                ...
                <div class="flex justify-center items-center mt-5">
                    <button class="w-[70%] h-10 bg-black text-white">Login</button>
                </div>
                <div class="flex justify-center items-center mt-5">
                    <p class=" text-xs w-[70%]">Don't have an account?<span class="text-blue-500 font-bold"> Register</span></p>
                </div>
